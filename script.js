...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const bicycles = [
    ...
    },
    {
      ...
      whatsappLink:
        "https://api.whatsapp.com/send?phone=51998393149&text=Olá+tenho+interesse+em+saber+sobre+bicicleta+Voltz+da+South+quanto+custa",
    },
    {
      ...
      whatsappLink:
        "https://api.whatsapp.com/send?phone=51998393149&text=Olá+tenho+interesse+em+saber+sobre+bicicleta+Legend+da+South+quanto+custa",
    },
  ];
